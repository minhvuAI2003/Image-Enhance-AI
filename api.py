...
def load_cnn_models():
    models = {}
    cnn_model_paths = {
        "gaussian_denoise": "CNN_models/gaussian_denoise.pth",
        "derain": "CNN_models/derain.pth",
        "single_image_deblur": "CNN_models/single_image_defocus_deblur.pth"
    }
...
async def auto_detect_and_process(file: UploadFile = File(...)):
    try:
        ...
        if best_metrics and best_metrics["psnr"] > 40 and best_metrics["ssim"] > 0.9:
            return {
                "status": "no_noise_detected",
