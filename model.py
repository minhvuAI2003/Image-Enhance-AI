...
class GDFN(nn.Module):
    ...
    def forward(self, x):
        ...
        gated = self.h_swish(x1) * torch.sigmoid(x2)
...
class MultiStreamTransformerBlock(nn.Module):
    def __init__(self, channels, num_heads, expansion_factor=2.66, streams=2):
    ...
    def forward(self, x):
        ...
        # Average các stream outputs
        attn_out = outs.mean(dim=0)
